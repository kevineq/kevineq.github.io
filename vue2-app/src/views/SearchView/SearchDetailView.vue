    ...
    >
      ...
      >
        ...
        <div class="month-wrap" v-for="m in months" :key="m.id">
          ...
          <div class="article-wrap" v-if="navTitle == '图文'">
            <MonthArticle
              v-for="a in m.articles"
              :key="a.id"
              :cover="a.cover"
              :date="a.maketime.split(' ')[0]"
...
import { getArticleList, titleTypes } from "@/utils/apis/articlecontent";
